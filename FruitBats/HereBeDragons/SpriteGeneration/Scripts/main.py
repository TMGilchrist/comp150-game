...
new_sprite = Sprite((16, 16), random.choice(images.base), random.choice(images.legs), random.choice(images.body), random.choice(images.hair), random.choice(images.feet), 0)
new_sprite.draw()
new_sprite.save_with_id(path_to_assets + "\Sprite   s\CustomSprites", "png")